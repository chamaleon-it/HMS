      ...
      <DraftProvider>
        <AppShell>
          <div className="p-6 space-y-6">
            ...
            <PatientTable data={tableData} tableMutate={refreshData} isAdmin={true} />

            <div className="flex items-center justify-between mt-4">
              <p className="text-sm text-gray-500">
                Showing <span className="font-medium text-gray-700">{tableData?.data?.length || 0}</span> patients
              </p>
            </div>
          </div>
