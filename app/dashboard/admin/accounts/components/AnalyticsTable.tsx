...
export function AnalyticsTable({
  ...
  return (
    <div className="bg-white rounded-3xl border border-slate-200/80 shadow-xs space-y-4 p-6">
      <div className="flex flex-wrap items-center justify-between gap-4">
        ...
        <div className="relative w-full sm:w-72">
          ...
          <Input
            ...
            className="pl-9 h-10 rounded-xl border-slate-200 bg-slate-50/50 hover:bg-slate-50 focus:bg-white transition-colors text-xs"
            value={searchTerm}
