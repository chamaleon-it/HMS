          ...
          <div className="flex items-center gap-3">
            {ip.status === "Discharged" && (
              <button
                ...
                className="flex items-center gap-2 px-4 py-1.5 rounded-xl bg-(--color-synapse-light) hover:opacity-90 text-white text-sm font-semibold transition-all shadow-md active:scale-95 cursor-pointer"
              >
