          ...
          <Table className="print:hidden min-w-[1200px] text-sm" containerClassName="max-h-[calc(100vh-365px)] overflow-y-auto scrollbar-thin scrollbar-thumb-slate-200">
            <TableHeader className="bg-[var(--color-cosmo-dark)] sticky top-0 z-20 shadow-sm">
              <TableRow className="bg-[var(--color-cosmo-dark)] hover:bg-[var(--color-cosmo-dark)] border-b-0">
                <TableHead className="py-2.5 text-left pl-4 w-16 text-white font-bold text-[11px] uppercase tracking-wider bg-[var(--color-cosmo-dark)]">Sl No</TableHead>
                <TableHead className="py-2.5 text-left text-white font-bold text-[11px] uppercase tracking-wider bg-[var(--color-cosmo-dark)]">Invoice</TableHead>
                <TableHead className="py-2.5 text-left text-white font-bold text-[11px] uppercase tracking-wider bg-[var(--color-cosmo-dark)]">Date</TableHead>
                <TableHead className="py-2.5 text-left text-white font-bold text-[11px] uppercase tracking-wider bg-[var(--color-cosmo-dark)]">Patient</TableHead>
                <TableHead className="py-2.5 text-left text-white font-bold text-[11px] uppercase tracking-wider bg-[var(--color-cosmo-dark)]">Doctor</TableHead>
                <TableHead className="py-2.5 text-right text-white font-bold text-[11px] uppercase tracking-wider bg-[var(--color-cosmo-dark)]">Items</TableHead>
                <TableHead className="py-2.5 text-right text-white font-bold text-[11px] uppercase tracking-wider bg-[var(--color-cosmo-dark)]">Total</TableHead>
                <TableHead className="py-2.5 text-right text-white font-bold text-[11px] uppercase tracking-wider bg-[var(--color-cosmo-dark)]">Round off</TableHead>
                <TableHead className="py-2.5 text-right text-white font-bold text-[11px] uppercase tracking-wider bg-[var(--color-cosmo-dark)]">Discount</TableHead>
                <TableHead className="py-2.5 text-right text-white font-bold text-[11px] uppercase tracking-wider bg-[var(--color-cosmo-dark)]">Paid</TableHead>
                <TableHead className="py-2.5 text-right text-white font-bold text-[11px] uppercase tracking-wider bg-[var(--color-cosmo-dark)]">Due</TableHead>
                <TableHead className="py-2.5 text-center text-white font-bold text-[11px] uppercase tracking-wider bg-[var(--color-cosmo-dark)]">Status</TableHead>
                <TableHead className="py-2.5 text-right pr-4 text-white font-bold text-[11px] uppercase tracking-wider bg-[var(--color-cosmo-dark)]">Action</TableHead>
              </TableRow>
            </TableHeader>
            <TableBody>
              {billing.length === 0 ? (
                      ...
                      <div className="flex justify-end items-center gap-1">
                        <Tooltip>
                          <TooltipTrigger asChild>
                            <Button variant="ghost" size="icon" asChild className="h-8 w-8 text-[var(--color-cosmo-copper)] hover:text-[var(--color-cosmo-copper)] hover:bg-blue-50">
                              <Link href={`/dashboard/admin/billing/single?id=${b._id}`}>
                        ...
                        <Button variant="outline" size="sm" onClick={() => handlePrint(b)} className="h-8 text-xs gap-1.5 text-[var(--color-cosmo-copper)] border-[var(--color-cosmo-copper)]/30 hover:bg-purple-50 hover:text-[var(--color-cosmo-copper)]">
