  ...
  return (
    <AppShell>
      <div className="relative bg-white rounded-2xl shadow-md border border-gray-100 overflow-hidden m-5">
        {/* Header Section */}
        <div className="flex justify-between items-center bg-linear-to-r from-[var(--color-synapse-purple)] to-[var(--color-synapse-dark)] text-white px-8 py-6 border-b">
        ...
        <div className="relative text-center text-xs text-gray-500 py-6 bg-linear-to-r from-gray-50 to-gray-100">
          <p>
            {configuration().hospitalAddress} | GSTIN: {configuration().gstIn}
