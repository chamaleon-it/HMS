...
import { CalendarIcon, Users, RotateCcw, Search } from "lucide-react";
        ...
        <div className="space-y-2">
          ...
          <div className="flex items-center gap-2">
            <Input
              ...
              className="w-20 h-11 bg-slate-50/50 border-slate-200 rounded-lg focus:ring-2 focus:ring-synapse-light/20 transition-all text-center"
            />
            ...
            {[
              ...
              return (
                <button
                  ...
                  className={`px-4 h-9 rounded-lg text-xs font-bold transition-all flex items-center gap-2 cursor-pointer whitespace-nowrap ${active ? "bg-(--color-synapse-light) text-white shadow-md shadow-indigo-100" : "text-slate-500 hover:text-slate-800 hover:bg-white/80"
                    }`}
                >
        ...
        return (
          <button
            ...
            className={`px-4 h-9 rounded-lg text-xs font-bold transition-all cursor-pointer whitespace-nowrap ${active
              ? "bg-white text-(--color-synapse-light) shadow-sm border border-slate-200"
