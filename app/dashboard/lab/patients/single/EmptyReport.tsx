  ...
  return (
    <div className="">
      <div className="rounded-2xl border border-gray-100 bg-white shadow-sm p-8 text-center">
        {/* subtle illustration */}
        <div className="mx-auto mb-6 w-28 h-28 flex items-center justify-center rounded-full bg-linear-to-br from-[var(--color-synapse-light)] to-[var(--color-synapse-purple)]">
        ...
        <div className="mt-6 flex justify-center gap-3">
          <Link href={ctaHref} className="inline-flex items-center rounded-md border border-transparent bg-linear-to-r from-[var(--color-synapse-light)] to-[var(--color-synapse-purple)] px-4 py-2 text-sm font-medium text-white shadow-sm hover:opacity-95">
            {ctaText}
          </Link>
