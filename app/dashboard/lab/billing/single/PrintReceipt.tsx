...
export default function PrintReceipt({
    ...
    for (let i = 0; i < payload.items.length; i += ITEMS_PER_PAGE) {
        pages.push(payload.items.slice(i, i + ITEMS_PER_PAGE));
    }
    if (pages.length === 0) {
        pages.push([]);
    }
            ...
            {pages.map((pageItems, pageIndex) => {
                ...
                return (
                    <div key={pageIndex} className="receipt-page">
                        ...
                        {/* 4. Bottom Section */}
                        <div className="flex justify-between items-stretch gap-1.5 select-none mt-auto mb-6">
                            ...
                            <div className="w-[64%] flex flex-col gap-1.5">
                                ...
                                <div className="flex-1 border border-[#9ca3af] rounded-[6px] px-4 py-2 flex text-[12px] text-black font-bold justify-between items-center bg-white">
                        ...
                        <div className={`w-[36%] border border-[#9ca3af] rounded-[6px] overflow-hidden bg-white flex flex-col justify-between ${!isLastPage ? 'opacity-0' : ''}`}>
