  ...
  return (
    <motion.div
      ...
      className={cn(
        ...
        isActive ? "ring-2 ring-[var(--color-cosmo-copper)]/20 border-[var(--color-cosmo-copper)]/30" : "",
    ...
    >
      ...
      >
        <div className="flex items-center gap-2 overflow-hidden">
          <div className={cn("w-2 h-2 rounded-full shrink-0", isActive ? "bg-[var(--color-cosmo-copper)]" : "bg-slate-300")} />
