            ...
            {debounced.length < MIN_QUERY_LEN ? (
              ...
              <div>
                ...
                <Link
                  ...
                  className="flex items-center gap-2 w-full text-left px-3 py-2 text-(--color-synapse-light) hover:bg-blue-50 font-medium"
                >
              ...
              //     asChild
              //     variant={"default"}
              //     className="bg-(--color-synapse-dark) text-white hover:bg-(--color-synapse-dark) transition"
              //     size={"sm"}
              //   >
