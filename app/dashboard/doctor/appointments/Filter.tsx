        ...
        <div className="flex flex-col lg:flex-row gap-4 lg:items-center lg:justify-between">
          <div className="flex-1 flex flex-col sm:flex-row items-stretch sm:items-center gap-3">
            <div className="relative flex-1 min-w-[260px] group">
              <Search className="h-4 w-4 absolute left-3 top-1/2 -translate-y-1/2 text-zinc-400 transition-colors group-focus-within:text-[var(--color-synapse-light)]" />
              <Input
                value={query}
                ...
                className="pl-9 h-11 bg-zinc-50/50 border-zinc-200 focus-visible:ring-[var(--color-synapse-light)]/20 focus-visible:border-[var(--color-synapse-light)] transition-all"
              />
            </div>
