  ...
  return (
    <div className="space-y-4 mb-6">
      <DoctorHeader
        ...
        subtitle={`(ID: ${appointment.patient.mrn}) • Age ${fAge(appointment?.patient?.dateOfBirth).formatted}, ${appointment.patient.gender} ${!!appointment.patient.allergies ? `• Allergies: ${appointment.patient.allergies}` : ""}`}
      >
