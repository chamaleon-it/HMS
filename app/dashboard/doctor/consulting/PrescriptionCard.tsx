          ...
          <div className="mb-4">
            ...
            <div className="border rounded-xl p-4">
                ...
                {data.medicines.map((m, i) => (
                  ...
                  >
                    ...
                    <div className="col-span-2 flex justify-end gap-2">
                      <Button
                        className="bg-[var(--color-synapse-dark)]! hover:bg-[var(--color-synapse-dark)]! text-white border-emerald-600!"
              ...
              <div className="mt-4 flex gap-3">
                <Button
                  onClick={addMedicineRow}
                  className="bg-[var(--color-synapse-dark)] hover:bg-[var(--color-synapse-dark)] text-white rounded-md"
                >
                  + Add Medicine
                </Button>
                <Button
                ...
                >
                  <CardContent className="p-3">
                    ...
                    <div className="flex flex-col gap-1 text-xs mb-3 max-h-24 overflow-y-auto pr-1">
                      {fav.medicines.map((med, idx) => (
                        <div key={idx} className="flex flex-wrap gap-1">
                          ...
                          <span className="bg-blue-100 text-[var(--color-synapse-light)] px-2 py-0.5 rounded-md">
                            {med.dosage}
                          </span>
                          <span className="bg-[#FDF6ED] text-[var(--color-synapse-light)] px-2 py-0.5 rounded-md">
                            {med.frequency}
                          </span>
                    ...
                    <Button
                      ...
                      size="sm"
                      className="w-full bg-[var(--color-synapse-dark)] hover:bg-[var(--color-synapse-dark)] text-white rounded-md"
                    >
                      Apply
                    </Button>
                  </CardContent>
