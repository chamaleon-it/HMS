        ...
        <div className="shrink-0 mb-4 px-4 sm:px-0 print:hidden">
          ...
          >
            <div className="flex gap-3 items-center">
              ...
              <PrimaryButton onClick={() => router.push("/dashboard/reception/billing#new")} className="bg-linear-to-br from-[var(--color-synapse-light)] to-[var(--color-synapse-purple)] shadow-indigo-200" title="Direct">
                Direct
              </PrimaryButton>
