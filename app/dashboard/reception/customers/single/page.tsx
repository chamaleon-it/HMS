                                                                    ...
                                                                    <TableCell className="py-3.5 pr-6 text-right">
                                                                        <div className="flex items-center justify-end gap-2">
                                                                            ...
                                                                            <Button
                                                                                ...
                                                                                className="rounded-xl bg-(--color-synapse-light) text-white text-xs font-semibold gap-1.5 cursor-pointer shadow-xs"
                                                                            >
                                    ...
                                    {creditBills.length > 0 && (
                                        <div className="flex items-center justify-end pt-2">
                                            <Button
                                                ...
                                                className="rounded-xl bg-(--color-synapse-light) text-white px-6 py-2.5 text-sm font-bold shadow-xs cursor-pointer flex items-center gap-2"
                                            >
