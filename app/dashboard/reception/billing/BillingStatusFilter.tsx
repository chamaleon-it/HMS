...
export default function BillingStatusFilter({
    ...
    const tabs = useMemo(
        () => [
            { key: "all", label: "All", icon: List, color: "var(--color-synapse-light)" },
            { key: "Paid", label: "Paid", icon: CheckCircle, color: "var(--color-synapse-light)" },
            { key: "Partial", label: "Partial", icon: Clock, color: "var(--color-synapse-light)" },
            { key: "Unpaid", label: "Unpaid", icon: XCircle, color: "var(--color-synapse-light)" },
        ],
        []
    );
