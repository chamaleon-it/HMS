                                            ...
                                            <div key={catName} className="space-y-3">
                                                ...
                                                >
                                                    {items.map((item) => {
                                                        ...
                                                        let tierStyles = "border-slate-200 bg-white text-slate-600 hover:bg-slate-50 hover:border-slate-300 hover:text-(--color-synapse-light)";
                                                        let Icon = null;
                                                        ...
                                                        if (isConsultation) {
                                                            ...
                                                            if (item.code === "CF1") {
                                                                ...
                                                                tierStyles = "border-slate-400 bg-slate-600 text-white hover:bg-(--color-synapse-dark) hover:border-slate-600 shadow-slate-500/10";
                                                                Icon = (
            ...
            <div className="bg-white rounded-xl shadow-md border border-slate-200 overflow-hidden">
                ...
                <div className="overflow-x-auto">
                    <table className="w-full table-fixed text-sm">
                        ...
                        <thead className="bg-(--color-synapse-dark)">
                                    ...
                                    return (
                                        <React.Fragment key={it.name}>
                                            <motion.tr
                                                ...
                                                className="border-b border-slate-100 last:border-0 hover:bg-synapse-light/10/30 group transition-colors"
                                            >
