                                            ...
                                            <div key={catName} className="space-y-3">
                                                ...
                                                >
                                                    {items.map((item) => {
                                                        ...
                                                        let tierStyles = "border-slate-200 bg-white text-slate-600 hover:bg-slate-50 hover:border-slate-300 hover:text-[var(--color-synapse-light)]";
                                                        let Icon = null;
                                                        ...
                                                        if (isConsultation) {
                                                            ...
                                                            if (item.code === "CF1") {
                                                                ...
                                                                tierStyles = "border-slate-400 bg-slate-600 text-white hover:bg-[var(--color-synapse-dark)] hover:border-slate-600 shadow-slate-500/10";
                                                                Icon = (
            ...
            <div className="bg-white rounded-xl shadow-md border border-slate-200 overflow-hidden">
                ...
                <div className="overflow-x-auto">
                    <table className="w-full table-fixed text-sm">
                        ...
                        <thead className="bg-[var(--color-synapse-dark)]">
                                    ...
                                    return (
                                        <React.Fragment key={it.name}>
                                            <motion.tr
                                                ...
                                                className="border-b border-slate-100 last:border-0 hover:bg-[var(--color-synapse-light)]/10/30 group transition-colors"
                                            >
                                                ...
                                                <td className="py-3 pl-3 pr-2">
                                                    <div className="space-y-1">
                                                        <input
                                                            ...
                                                            readOnly
                                                            disabled
                                                            className="h-11 w-full rounded-lg border border-slate-200 bg-white px-3 text-sm font-medium text-slate-700 outline-none focus:border-[var(--color-synapse-light)] focus:ring-2 focus:ring-[var(--color-synapse-light)]/20 transition-all"
                                                        />
                                                    </div>
                                                </td>
                                                <td className="py-3 pr-2 text-right">
                                                    <input
                                                        ...
                                                        className="h-11 w-full rounded-lg border border-slate-200 bg-[var(--color-synapse-light)]/10/30 px-3 text-sm font-bold text-[var(--color-synapse-light)] outline-none focus:border-[var(--color-synapse-light)] focus:ring-2 focus:ring-[var(--color-synapse-light)]/20 transition-all text-center"
                                                    />
                                                </td>
                                                <td className="py-3 pr-2 text-right">
                                                    <input
                                                        ...
                                                        className="h-11 w-full rounded-lg border border-slate-200 bg-white px-3 text-sm font-medium text-slate-600 outline-none focus:border-[var(--color-synapse-light)] focus:ring-2 focus:ring-[var(--color-synapse-light)]/20 transition-all text-right"
                                                    />
                                                </td>
                                                <td className="py-3 pr-2 text-right">
                                                    <input
