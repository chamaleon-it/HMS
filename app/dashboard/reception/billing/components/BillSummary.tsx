    ...
    return (
        ...
        >
            ...
            <div className="space-y-3">
                ...
                <div className="bg-[var(--color-synapse-dark)] -mx-4 sm:-mx-5 px-4 sm:px-5 py-3 mt-4 shadow-2xl shadow-[var(--color-synapse-purple)]/20 relative overflow-hidden group">
