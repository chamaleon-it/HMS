...
import { ArrowDownLeft, ArrowUpRight, Calendar, User, FileText, Tag, Receipt, CreditCard, Layers } from "lucide-react";
      ...
      <DialogContent className="sm:max-w-md bg-white rounded-2xl p-6">
        ...
        <div className="py-4 space-y-4">
          ...
          <div className="grid grid-cols-2 gap-4 text-sm">
            ...
            <div className="bg-slate-50 p-3 rounded-xl border border-slate-100">
              <span className="text-xs text-slate-500 flex items-center gap-1 font-medium">
                <Layers className="w-3.5 h-3.5 text-slate-500" /> Source Module
              </span>
              <span className="font-bold text-blue-700 block mt-1">
                {transaction.sourceModule || "Uncategorised"}
              </span>
            </div>
