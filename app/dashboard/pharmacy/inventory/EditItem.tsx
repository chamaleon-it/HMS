    ...
    >
      <div>
        ...
        <div className="text-xs text-gray-500">
          Last updated: {new Date().toLocaleDateString("en-GB", { day: "numeric", month: "short", year: "numeric" })} by {user?.name || "Staff"} (Pricing & stock managed at batch level)
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 text-sm">
        ...
        <div className="sm:col-span-2">
          ...
          <Input
            placeholder="e.g. Bilastine 20 mg"
            className="mt-1"
            {...register("generic")}
            ref={(e) => {
        ...
        <div>
          ...
          <Select
            defaultValue={item.status as "Active" | "Inactive" || "Active"}
