  ...
  return (
    ...
    >
      ...
      <div className="flex gap-2 pt-2">
        <Button className="bg-[var(--color-cosmo-copper)] hover:bg-[var(--color-cosmo-copper)] text-white flex-1 h-11 shadow-md font-semibold" type="submit" ref={refs.saveButton}>
          Save Medicine
        </Button>
        <Button
          variant="outline"
