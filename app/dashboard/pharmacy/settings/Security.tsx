      ...
      <form onSubmit={changePassword}>
        <Card className="border-0 shadow-lg ring-1 ring-black/5 bg-white/80 backdrop-blur">
          ...
          <CardFooter className="justify-between gap-2 flex-wrap">
            <Button
              className="gap-2 bg-linear-to-r from-[var(--color-synapse-dark)] to-[var(--color-synapse-purple)] text-white hover:from-[var(--color-synapse-purple)] hover:to-[var(--color-synapse-purple)] disabled:opacity-60 shadow-sm"
              type="submit"
            >
  ...
  return (
    <Card className="border-0 shadow-lg ring-1 ring-black/5 bg-white/80 backdrop-blur">
      ...
      <CardContent>
        ...
        <Button
          className="gap-2 bg-linear-to-r from-[var(--color-synapse-dark)] to-[var(--color-synapse-purple)] text-white hover:from-[var(--color-synapse-purple)] hover:to-[var(--color-synapse-purple)] disabled:opacity-60 shadow-sm mt-5"
