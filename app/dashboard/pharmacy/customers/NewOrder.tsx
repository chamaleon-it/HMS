...
export default function NewOrder({ mutate }: { mutate: () => void }) {
  ...
  return (
    <>
      <Button variant={"outline"} onClick={() => { setNameToRegister(""); setOpenCreate(true); }} className="bg-emerald-600 hover:bg-emerald-700 text-white hover:text-white">Create Customer</Button>
