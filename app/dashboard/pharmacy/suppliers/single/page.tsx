        ...
        <AppShell>
                    ...
                    <section className="grid gap-4 lg:grid-cols-3 items-stretch">
                        ...
                        <div className="border rounded-2xl p-5 bg-white flex flex-col gap-1 shadow-sm lg:col-span-2 transition-transform duration-150 hover:-translate-y-[2px]">
                            ...
                            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 mt-3">
                                ...
                                <div className="flex items-center gap-3 p-2 rounded-xl bg-slate-50 border border-slate-100">
                                    <div className="p-2 bg-[var(--color-cosmo-copper)]/20 rounded-lg">
                                        <MapPin className="w-3.5 h-3.5 text-[var(--color-cosmo-copper)]" />
                                    </div>
                                ...
                                <div className="flex items-center gap-3 p-2 rounded-xl bg-slate-50 border border-slate-100">
                                    <div className="p-2 bg-[#FDF6ED] rounded-lg">
                                        <User className="w-3.5 h-3.5 text-[var(--color-cosmo-copper)]" />
                                    </div>
                                    <div className="min-w-0">
                                ...
                                <div className="flex items-center gap-3 p-2 rounded-xl bg-slate-50 border border-slate-100">
                                    <div className="p-2 bg-blue-100 rounded-lg">
                                        <Mail className="w-3.5 h-3.5 text-[var(--color-cosmo-copper)]" />
                                    </div>
                                    <div className="min-w-0">
                                    ...
                                    return (
                                        <button
                                            ...
                                            className={cn(
                                                ...
                                                active ? "bg-[var(--color-cosmo-dark)] text-slate-50" : "hover:bg-slate-50"
                                            )}
                                        >
                                ...
                                <div className="flex-1 overflow-auto ">
                                    ...
                                    <div className="p-6 bg-slate-50/50 flex flex-col gap-3">
                                        <div className="grid grid-cols-2 gap-x-8 gap-y-2 max-w-sm ml-auto">
                                            ...
                                            <div className="text-[var(--color-cosmo-copper)] text-right font-bold text-base">{formatINR(selectedOrder.total)}</div>
                                            ...
                                            {selectedOrder.paymentStatus !== "Paid" && (
                                                <div className="col-span-2 pt-4">
                                                    <Button
                                                        ...
                                                        className="w-full bg-linear-to-r from-[var(--color-cosmo-copper)] to-[var(--color-cosmo-brown)] hover:from-[var(--color-cosmo-copper)] hover:to-[var(--color-cosmo-brown)] text-white shadow-lg shadow-indigo-200/50 h-11 font-semibold text-sm rounded-xl transition-all hover:scale-[1.01]"
                                                    >
                                                        Pay Due Amount
                                                    </Button>
                                                </div>
            ...
            <Dialog open={isPaymentModalOpen} onOpenChange={setIsPaymentModalOpen}>
                <DialogContent className="sm:max-w-md rounded-2xl border-none shadow-2xl p-0 overflow-hidden ">
                    <div className="bg-linear-to-r from-[var(--color-cosmo-copper)] to-[var(--color-cosmo-brown)] p-6 text-white">
                        <DialogTitle className="text-xl font-semibold flex items-center gap-2">
                            Process Payment
                        </DialogTitle>
                        <p className="text-[var(--color-cosmo-copper)]/80 text-xs mt-1 font-medium tracking-wide">
                        ...
                        <div className="space-y-3">
                            ...
                            <div className="relative">
                                ...
                                <Input
                                    type="number"
                                    placeholder="0.00"
                                    className="h-16 text-2xl font-bold bg-slate-50 border-2 border-slate-100 rounded-2xl pl-10 focus:ring-4 focus:ring-[var(--color-cosmo-copper)]/10 focus:border-[var(--color-cosmo-copper)]/50 transition-all text-[var(--color-cosmo-copper)] placeholder:text-slate-300"
                                    value={paymentAmount}
                    ...
                    <div className="p-6 bg-slate-50/50 border-t flex gap-3">
                        ...
                        <Button
                            className="flex-2 h-12 rounded-xl bg-linear-to-r from-[var(--color-cosmo-copper)] to-[var(--color-cosmo-brown)] hover:from-[var(--color-cosmo-copper)] hover:to-[var(--color-cosmo-brown)] text-white shadow-lg shadow-indigo-200 font-semibold"
