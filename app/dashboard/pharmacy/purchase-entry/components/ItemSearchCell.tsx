        ...
        <Popover open={open} onOpenChange={setOpen}>
            <PopoverTrigger asChild>
                <Button
                    ...
                    role="combobox"
                    className={cn(
                        "w-full h-11 justify-between text-sm border border-slate-200 bg-white hover:bg-slate-50 hover:border-synapse-light/30 hover:shadow-md transition-all rounded-lg",
                    ...
                    <CommandList className="">
                        ...
                        {!isLoading && items.length === 0 && query && (
                            <CommandEmpty className="py-6 text-center text-slate-500 text-sm flex flex-col items-center gap-3">
                                ...
                                <Button
                                    size="sm"
                                    className="h-9 bg-(--color-synapse-light) hover:bg-(--color-synapse-light) text-white gap-2 font-semibold shadow-md "
                                    onClick={() => {
                        ...
                        <CommandGroup className="p-2 ">
                            {items.map((it) => (
                                <CommandItem
                                    ...
                                    className="rounded-lg h-10 px-3 aria-selected:bg-synapse-light/10 aria-selected:text-(--color-synapse-light) font-medium transition-colors cursor-pointer mb-1 "
                                >
                                    <Check
                                        className={cn(
                                            "mr-3 h-4 w-4 text-(--color-synapse-light) transition-all",
