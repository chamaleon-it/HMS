    ...
    return (
        <div className="relative flex items-center gap-1">
            <Input
                ...
                className={cn(
                    "h-11 bg-white border-slate-200 rounded-lg focus:bg-white focus:border-[var(--color-synapse-light)] focus:ring-4 focus:ring-[var(--color-synapse-light)]/5 transition-all text-center text-sm pr-10",
                    className
                )}
                value={displayValue}
            ...
            <Popover open={open} onOpenChange={setOpen}>
                <PopoverTrigger asChild>
                    <Button
                        ...
                        variant="ghost"
                        size="icon"
                        className="absolute right-1 h-9 w-9 hover:bg-[var(--color-synapse-light)]/10 rounded-md transition-colors"
                    >
                        <CalendarIcon className="h-4 w-4 text-[var(--color-synapse-light)]" />
                    </Button>
                </PopoverTrigger>
                <PopoverContent className="w-auto p-0" align="start">
                    <div className="w-64 p-3 bg-white rounded-xl shadow-xl border border-slate-100">
                        <div className="space-y-3">
                                    ...
                                    return (
                                        <button
                                            ...
                                            className={cn(
                                                ...
                                                isSelected
                                                    ? "bg-[var(--color-synapse-light)] text-white shadow-md shadow-indigo-200"
                                                    : disabled
                                                        ? "text-slate-200 cursor-not-allowed"
                                                        : "hover:bg-slate-50 text-slate-600 hover:text-[var(--color-synapse-light)]"
                                            )}
                                            onClick={() => {
                            ...
                            <div className="border-t border-slate-100 pt-3">
                                ...
                                >
                                    ...
                                    <SelectContent className="rounded-xl border-slate-200">
                                        {years.map((y: number) => (
                                            <SelectItem key={y} value={String(y)} className="text-xs rounded-lg focus:bg-[var(--color-synapse-light)]/10">
                                                {y}
                                            </SelectItem>
                                        ))}
                                    </SelectContent>
                            ...
                            <Button
                                type="button"
                                className="w-full h-10 text-[10px] font-semibold uppercase tracking-widest bg-[var(--color-synapse-light)] hover:bg-[var(--color-synapse-light)] text-white rounded-lg shadow-lg shadow-indigo-100 transition-all"
