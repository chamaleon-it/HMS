    ...
    <div ref={rootRef} className="relative w-full z-50">
      ...
      >
        <Input
          ...
          onKeyDown={onKeyDown}
          className="w-full h-8 border-slate-200 bg-slate-50/50 focus:bg-white focus:border-[var(--color-cosmo-copper)] focus:ring-2 focus:ring-[var(--color-cosmo-copper)]/20 rounded-lg transition-all"
        />
