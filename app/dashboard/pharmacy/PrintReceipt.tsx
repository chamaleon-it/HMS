    ...
    return (
      ...
      `}} />
            ...
            <div className="max-w-[21cm] mx-auto min-h-screen p-[1.5cm] flex flex-col text-[10.5px]">
                ...
                {/* Signatures */}
                <div className="mt-3 flex justify-between items-end h-24">
                ...
                <div className="mt-auto pt-3 text-center border-t border-slate-200 flex flex-col gap-1 items-center">
                ...
                <p className="text-[10px] font-black text-slate-900 uppercase tracking-widest leading-none mt-4 text-center">Powered By Synapse IT Services LLP</p>
