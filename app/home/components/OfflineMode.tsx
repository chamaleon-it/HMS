                    ...
                    <div className="lg:w-1/2">
                        <div className="flex flex-wrap gap-3 mb-8">
                            {activeTab === 'hybrid' ? (
                                ...
                                <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-blue-100 border border-blue-200 text-[var(--color-cosmo-copper)] font-bold text-sm">
                        ...
                        {activeTab === 'hybrid' ? (
                            ...
                            <>
                                ...
                                <div className="space-y-6">
                                    <div className="flex items-start gap-4">
                                        <div className="p-3 bg-[var(--color-cosmo-copper)] text-white rounded-xl">
                    ...
                    <div className="lg:w-1/2 relative">
                        {activeTab === 'hybrid' ? (
                            ...
                            <div className="relative bg-slate-100 rounded-3xl p-8 border border-slate-200 shadow-2xl">
                                ...
                                <div className="absolute bottom-8 right-8 bg-white p-4 rounded-2xl shadow-xl border border-slate-100 flex items-center gap-4">
                                    <div className="relative">
                                        <RefreshCw className="w-6 h-6 text-[var(--color-cosmo-copper)] animate-spin" />
                                    </div>
                                    <div>
                            ...
                            <div className="relative bg-slate-900 rounded-3xl p-8 border border-slate-800 shadow-2xl overflow-hidden">
                                ...
                                <div className="absolute top-8 right-8 flex items-center gap-2 px-4 py-2 bg-[var(--color-cosmo-copper)]/20 text-blue-400 rounded-full font-bold text-sm border border-blue-500/30">
                                    <Lock className="w-4 h-4" /> SECURE LOCAL
                                </div>

                                <div className="relative z-10 mt-12 space-y-6">
                                    <div className="flex items-center justify-center">
                                        <div className="w-32 h-32 rounded-full bg-[var(--color-cosmo-copper)]/10 flex items-center justify-center border border-blue-500/20 shadow-[0_0_50px_rgba(59,130,246,0.2)]">
                                            <Server className="w-16 h-16 text-[var(--color-cosmo-copper)]" />
                                        </div>
                                    </div>
                                    ...
                                    <div className="bg-black/50 rounded-xl p-4 border border-white/5">
                                        ...
                                        <div className="h-2 w-full bg-slate-800 rounded-full overflow-hidden">
                                            <div className="h-full w-[60%] bg-[var(--color-cosmo-copper)]" />
                                        </div>
                                    </div>
                                </div>
                            </div>
