          ...
          <Button
            className={`h-8 text-xs font-semibold rounded-lg transition-all duration-200 shadow-sm border flex items-center gap-2 ${buttonText === "Ready"
              ...
              : buttonText === "Completed"
                ? "text-(--color-synapse-light) bg-white border-blue-100 hover:bg-blue-50 hover:text-(--color-synapse-light)"
        ...
        <DialogContent className="sm:max-w-225 p-0 overflow-hidden gap-0">
                      ...
                      return sortedTests.map((labTest) => (
                        ...
                        >
                          <TableCell className="pl-6 py-4">
                            <div className="flex items-center gap-3">
                              <div className="p-2 bg-white border border-gray-100 text-(--color-synapse-light) rounded-lg shadow-sm group-hover:border-blue-100 group-hover:shadow-md transition-all">
          ...
          <DialogFooter className="px-6 py-4 border-t border-gray-100 bg-white">
            ...
            <Button
              ...
              className="gap-2 bg-(--color-synapse-light) hover:bg-(--color-synapse-light) text-white shadow-blue-100 shadow-lg"
            >
            ...
            <Button
              ...
              className="gap-2 bg-(--color-synapse-dark) hover:bg-(--color-synapse-dark) text-white shadow-(--color-synapse-light)/30 shadow-lg"
            >
        ...
        <AlertDialogContent>
          ...
          <AlertDialogFooter className="mt-6 flex gap-2 sm:justify-end">
            ...
            <AlertDialogAction asChild>
              <Button
                variant="default"
                className="bg-(--color-synapse-dark) text-white hover:bg-(--color-synapse-dark)"
                onClick={() => {
