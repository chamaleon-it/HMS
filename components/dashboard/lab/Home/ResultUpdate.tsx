          ...
          <Button
            className={`h-8 text-xs font-semibold rounded-lg transition-all duration-200 shadow-sm border flex items-center gap-2 ${buttonText === "Ready"
              ...
              : buttonText === "Completed"
                ? "text-[var(--color-synapse-light)] bg-white border-blue-100 hover:bg-blue-50 hover:text-[var(--color-synapse-light)]"
        ...
        <DialogContent className="sm:max-w-225 p-0 overflow-hidden gap-0">
          ...
          <DialogFooter className="px-6 py-4 border-t border-gray-100 bg-white">
            ...
            <Button
              ...
              className="gap-2 bg-[var(--color-synapse-light)] hover:bg-[var(--color-synapse-light)] text-white shadow-blue-100 shadow-lg"
            >
            ...
            <Button
              ...
              className="gap-2 bg-[var(--color-synapse-dark)] hover:bg-[var(--color-synapse-dark)] text-white shadow-[var(--color-synapse-light)]/30 shadow-lg"
            >
        ...
        <AlertDialogContent>
          ...
          <AlertDialogFooter className="mt-6 flex gap-2 sm:justify-end">
            ...
            <AlertDialogAction asChild>
              <Button
                variant="default"
                className="bg-[var(--color-synapse-dark)] text-white hover:bg-[var(--color-synapse-dark)]"
                onClick={() => {
