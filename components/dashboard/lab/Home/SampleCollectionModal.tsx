        ...
        <Dialog open={open} onOpenChange={(val) => {
            ...
            <DialogTrigger asChild>
                <Button
                    variant="outline"
                    size="sm"
                    className="bg-white text-(--color-synapse-light) border-blue-200 hover:bg-blue-50 hover:text-(--color-synapse-light) gap-2 h-8 text-xs font-semibold shadow-sm transition-all duration-200"
                >
            ...
            <DialogContent className="sm:max-w-[550px]">
                ...
                <div className="py-4 space-y-4">
                    ...
                    <Button
                        ...
                        className="mt-4 w-full border-dashed text-(--color-synapse-light) border-blue-200 hover:bg-blue-50 hover:text-(--color-synapse-light) h-9 font-medium"
                    >
                        + Add Another Sample
                    </Button>
                </div>
                ...
                <DialogFooter>
                    ...
                    <Button
                        ...
                        disabled={loading}
                        className="bg-linear-to-br from-(--color-synapse-light) to-(--color-synapse-purple) hover:from-(--color-synapse-light) hover:to-(--color-synapse-purple) text-white"
                    >
