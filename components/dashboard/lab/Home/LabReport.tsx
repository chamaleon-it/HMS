        ...
        >
          ...
          <div className="flex items-center gap-3 flex-wrap">
            ...
            <div className="flex items-center gap-3 px-3 py-2 rounded-2xl border border-slate-200 bg-white/80 backdrop-blur-sm shadow-xs hover:shadow-sm transition-all duration-200">
              <div className="flex items-center justify-center w-8 h-8 rounded-full bg-blue-50 text-(--color-cosmo-copper) shadow-inner">
            ...
            <div className="flex items-center gap-4 px-3 py-2 rounded-2xl border border-slate-200 bg-white/80 backdrop-blur-sm shadow-xs transition-all duration-200 hover:shadow-sm">
              ...
              <button
                ...
                className={cn(
                  ...
                  showSampleId ? "bg-linear-to-r from-(--color-cosmo-copper) to-(--color-cosmo-brown)" : "bg-slate-100"
                )}
              >
                <span className={cn(
