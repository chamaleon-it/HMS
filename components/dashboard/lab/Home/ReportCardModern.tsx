                                ...
                                <>
                                    ...
                                    <div className="bg-[#f5f5f0] px-8 py-[18px] flex justify-between w-full">
                                        <div className="flex flex-col space-y-[9px] text-[12px] font-medium text-slate-600 tracking-wide">
                                            ...
                                            <div className="flex items-center"><span className="w-24">Age/Sex</span><span className="w-6 text-slate-700 font-bold">:</span><span className="font-extrabold text-slate-900">{patient?.dateOfBirth ? `${fAge(patient.dateOfBirth).formatted}` : "46 yr"} / {patient?.gender || "Other"}</span></div>
