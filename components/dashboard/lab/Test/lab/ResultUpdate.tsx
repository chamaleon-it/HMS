        ...
        <Dialog open={open} onOpenChange={setOpen}>
            ...
            <DialogContent className="sm:max-w-[800px] p-0 overflow-hidden gap-0">
                                            ...
                                            <TableCell className="pr-6 py-4 text-right">
                                                <div className="flex flex-col items-end gap-0.5">
                                                    <span className="text-sm font-medium text-gray-700">
                                                        {labTest.name?.range?.[0]?.min ?? "0"} - {labTest.name?.unit ? labTest.name?.unit : ""} {labTest.name?.range?.[0]?.max ?? "N/A"}
                                                    </span>
                ...
                <DialogFooter className="px-6 py-4 border-t border-gray-100 bg-white">
                    ...
                    <Button onClick={updateResult} className="gap-2 bg-(--color-synapse-light) hover:bg-(--color-synapse-light) text-white shadow-blue-100 shadow-lg">
