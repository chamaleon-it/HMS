                                    ...
                                    <td className="px-3 py-2">
                                        <div className="flex flex-col">
                                            ...
                                            <span className="text-xs text-gray-500 mt-0.5">
                                                <span className="font-medium text-gray-600">{r?.patient?.mrn}</span> • {fAge(r?.patient?.dateOfBirth).formatted} • {r?.patient?.gender}
                                            </span>
                                        </div>
                                    </td>
                                            ...
                                            {r.test.map(
                                                (e) => {
                                                    if (e.name?.type === "Lab") {
                                                        ...
                                                        if (e.value && e.name?.range?.[0]?.min && e.name?.range?.[0]?.max) {
