...
export default function ExistingPatientCard({
    ...
    return (
        <div
            className="absolute top-[calc(100%+4px)] left-0 w-full z-50 p-3 border rounded-xl shadow-xl bg-white cursor-pointer hover:border-synapse-light/30 transition-colors group"
                ...
                <div className="flex gap-3 items-center">
                    ...
                    <div>
                        ...
                        <div className="flex items-center gap-2 mt-1">
                            <span className="inline-flex items-center px-1.5 py-0.5 rounded-md bg-blue-50 text-(--color-synapse-light) text-[10px] font-medium">
