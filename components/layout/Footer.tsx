...
export default function Footer() {
  return (
    <footer className="border-t border-transparent bg-linear-to-r from-[var(--color-cosmo-copper)] via-[var(--color-cosmo-brown)] to-[var(--color-cosmo-brown)] text-white print:hidden">
