...
export default function HospitalName({ className, textClassName, subTextClassName, dark }: HospitalNameProps) {
    ...
    return (
        <div className={cn("flex gap-3.5 items-center font-montserrat", className)}>
            ...
            <div className="flex flex-col gap-0.5">
                <h1 className={cn("text-xl font-bold tracking-tight font-montserrat", dark ? "text-white" : (textClassName || "text-slate-900"))}>
